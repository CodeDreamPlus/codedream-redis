...
import com.codedream.redis.ratelimiter.RedisRateLimiterAspect;
import com.codedream.redis.ratelimiter.RedisRateLimiterClient;
...
public class RateLimiterAutoConfiguration {
	...
	private RedisScript<List<Long>> redisRateLimiterScript() {
		...
		redisScript.setScriptSource(new ResourceScriptSource(new ClassPathResource("META-INF/scripts/codedream_rate_limiter.lua")));
